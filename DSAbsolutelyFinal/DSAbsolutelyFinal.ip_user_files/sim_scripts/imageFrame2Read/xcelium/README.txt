...
#
# Generated by export_simulation on Fri Nov 15 17:52:37 +0530 2019
#
################################################################################
...
'-reset_run' switch to the './imageFrame2Read.sh' script.

./imageFrame2Read.sh -reset_run
...
./imageFrame2Read.sh -noclean_files

For more information on the script, please type './imageFrame2Read.sh -help'.
