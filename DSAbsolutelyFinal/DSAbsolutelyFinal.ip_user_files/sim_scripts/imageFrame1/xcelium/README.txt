...
#
# Generated by export_simulation on Fri Nov 15 17:51:26 +0530 2019
#
################################################################################
...
'-reset_run' switch to the './imageFrame1.sh' script.

./imageFrame1.sh -reset_run
...
./imageFrame1.sh -noclean_files

For more information on the script, please type './imageFrame1.sh -help'.
