...
#
# Generated by export_simulation on Fri Nov 15 17:52:04 +0530 2019
#
################################################################################
...
'-reset_run' switch to the './imageFrame2.sh' script.

./imageFrame2.sh -reset_run
...
./imageFrame2.sh -noclean_files

For more information on the script, please type './imageFrame2.sh -help'.
