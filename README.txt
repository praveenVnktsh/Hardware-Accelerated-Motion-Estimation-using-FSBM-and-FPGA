...
This project implements block matching using full search between two consecutive 96 x 96 pixel frames of a video sequence and displays the motion vectors on a VGA display. 
...
* Praveen Venkatesh (18110127) (Group Leader)
* Nishikant Parmar (1811108)
* Chris Francis (18110041)
* Prankush Agarwal (18110123)

----------------------------------------------------------------------------------------------------------------------

GitHub repository Link: https://github.com/awesomeroks/Hardware_Accelerated_Motion_Estimation_NEXYS-4_FPGA
